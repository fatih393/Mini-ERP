        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fatih = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
                    SupplierId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    CollectorEmployeeId = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    QualityEmployeeId = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MilkCollections_CollectorEmployeeId",
                table: "MilkCollections",
                column: "CollectorEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_MilkCollections_QualityEmployeeId",
                table: "MilkCollections",
